...
public class ErrorMessage {
	...
	public static ErrorMessage undefinedMethod(String name) {
		return new ErrorMessage("Undefined Method: "+name);
	}
	
	public static ErrorMessage undefinedType(String name) {
		return new ErrorMessage("Undefined Type: "+name);
	}
	...
	public static ErrorMessage numOfArgumentsError(String functionName, int expected, int actual) {
		return new ErrorMessage( functionName + " expected " + expected + " arguments, recieved " + actual);
	}
	
	public static ErrorMessage duplicateMainClass(String name) {
		return new ErrorMessage("Class " + name + " contains a main method when one has already been defined");
	}
