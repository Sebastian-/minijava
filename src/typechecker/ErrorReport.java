...
public class ErrorReport {
	...
	public void duplicateMainClass(String name) {
		report(ErrorMessage.duplicateMainClass(name));
	}
	...
	public void undefinedMethod(String name) {
		report(ErrorMessage.undefinedMethod(name));
	}
	
	public void undefinedType(String name) {
		report(ErrorMessage.undefinedType(name));
	}
	...
	public void functionError(String functionName, int expected, int actual) {
		report(ErrorMessage.numOfArgumentsError(functionName, expected, actual));
	}
}
